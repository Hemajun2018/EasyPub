...
export function FormatterButton({
  ...
  const variants = {
    primary: 'bg-primary text-primary-foreground shadow-sm hover:opacity-90 focus:ring-primary',
    secondary:
      'border border-border bg-secondary text-secondary-foreground shadow-sm hover:bg-secondary/80 focus:ring-ring',
