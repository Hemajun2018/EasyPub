...
description: EasyPub Privacy Policy
created_at: 2025-10-24
---

## Introduction

Welcome to EasyPub, an **AI-powered formatter for WeChat Official Accounts**. At EasyPub, your privacy is of utmost importance to us, and this privacy policy outlines how we collect, use, and protect your personal information when you use our services.

## Information Collection and Use

We collect the following types of data to provide you with a better experience while using EasyPub:
...
2. **Usage Details**
  - **What We Collect**: Information about how you use EasyPub, including your interactions, features accessed, and usage frequency.
...
**Copyright Owner**: [www.easypub.space](https://www.easypub.space)
**Email**: [support@easypub.space](mailto:support@easypub.space)

By using EasyPub, you consent to our privacy policy and agree to its terms. Thank you for trusting us with your information!
